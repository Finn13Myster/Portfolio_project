...
border-white text-center group cursor-pointer hover:border-gray-600 duration-200"
>
    <div
        class="bg-transparent grid place-items-center px-4 text-5xl md:text-6xl -mt-10 sm:-mt-12 md:-mt-14 lg:-mt-16 mx-auto duration-200"
    >
        <i class={step.icon} />
    </div>
